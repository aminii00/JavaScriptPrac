...
@WebServlet("/jsonSevlet3")
public class jsonSevlet3 extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        bookInfo.put("image","http://localhost:8080/Pro03/images/image1.jpg");
        ...
        bookInfo.put("genre","IT");
        bookInfo.put("image","http://localhost:8080/Pro03/images/image2.jpg");
        bookArray.add(bookInfo);
